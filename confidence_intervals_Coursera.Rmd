...
samp %>%
  summarise(xbar = mean(area), med = median(area))
...
<ol>
<li> The sample is random. YYYYYY???? </li>
...
<li> 95% of random samples of size 60 will yield confidence intervals that contain the true average area of houses in Ames, Iowa. YYYYYYYYYYY </li>
...
ggplot(data = ci2_data, aes(x = ci2_bound,
                            y = ci2_id,
                            group = ci2_id,
                            color = ci2_capture)) +
  geom_point(size = 2) +
