...
<li> 50\% of houses in Ames are smaller than 1,499.69 square feet.Y </li> XXXXXXXX
...
<li> Sample size of 100. </li> YYYYYYYY
<li> Sample size of 1000. Y </li>
</ol>
...
sample_means50 %>%
  summarise(mean_x_bar = mean(x_bar))
```
...
sample_means_small <- ames %>%
  rep_sample_n(size = 10, reps = 25, replace = T)%>%
...
<ol>
<li> Each element represents a mean square footage from a simple random sample of 10 houses. YYYYY </li>
...
ggplot(data = sample_means50, aes(x = xbar)) +
...
sample_means150 <- ames %>%
  ...
  summarise(xbar2 = mean(price))

ggplot(data = sample_means150, aes(x = xbar2)) +
  geom_histogram(binwidth = 5000)
```
...
sample_means15 <- ames %>%
  ...
  summarise(xbar3 = mean(price))

ggplot(data = sample_means15, aes(x = xbar3)) +
  geom_histogram(binwidth = 5000)
...
sample_means150 <- ames %>%
  ...
  summarise(xbar4 = mean(price))

ggplot(data = sample_means150, aes(x = xbar4)) +
  geom_histogram(binwidth = 5000)
```

6. Which of the following is false? 
<ol>
<li> The variability of the sampling distribution with the smaller sample size (`sample_means50`) is smaller than the variability of the sampling distribution with the larger sample size (`sample_means150`).YYYYYYYYY </li>
